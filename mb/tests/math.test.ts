...
describe('shouldRebalance', () => {
  ...
  it('returns true when deviation equals threshold', () => {
    expect(shouldRebalance(5100, 100)).toBe(true);
  });
...
describe('computeRebalanceTrade', () => {
  ...
  it('sells exactly half the excess', () => {
    // 750 SOL, 250 BRL → target = 500 each → sell 250 BRL worth of SOL
...
describe('brlToSol', () => {
  ...
  it('floors to avoid rounding above available', () => {
    // 100 / 3 = 33.333... → floored at 8 decimals = 33.33333333
